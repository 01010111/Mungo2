...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/auto_tiles.png", __ASSET__assets_images_auto_tiles_png);
		type.set ("assets/images/auto_tiles.png", AssetType.IMAGE);
		className.set ("assets/images/images-go-here.txt", __ASSET__assets_images_images_go_here_txt);
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		className.set ("assets/images/mungo.png", __ASSET__assets_images_mungo_png);
		type.set ("assets/images/mungo.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_auto_tiles_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_images_go_here_txt extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_mungo_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/auto_tiles.png") #if display private #end class __ASSET__assets_images_auto_tiles_png extends lime.graphics.Image {}
...
@:image("assets/images/mungo.png") #if display private #end class __ASSET__assets_images_mungo_png extends lime.graphics.Image {}
